...
int main(int argC, char* argV[])
{
    ...
    if (!parser->loadGrammar(argV[1], Grammar::SchemaGrammarType, true)) //载入xsd
    {
        std::cout << "导入2.xsd失败" << std::endl;
        return -1;
    }
    ...
    //parser->setExternalNoNamespaceSchemaLocation("./2.xsd");      //如果xml不带ns则用这个
