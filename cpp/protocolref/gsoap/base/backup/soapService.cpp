...
static int serve_ns__add(struct soap*, Service*);
static int serve_ns__sub(struct soap*, Service*);
static int serve_ns__mul(struct soap*, Service*);
static int serve_ns__divid(struct soap*, Service*);
...
int Service::dispatch(struct soap* soap)
{
	...
	if (!soap_match_tag(soap, soap->tag, "ns:divid"))
		return serve_ns__divid(soap, this);
	return soap->error = SOAP_NO_METHOD;
}

static int serve_ns__add(struct soap *soap, Service *service)
{	struct ns__add soap_tmp_ns__add;
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = service->add(soap_tmp_ns__add.iNum1, soap_tmp_ns__add.iNum2, soap_tmp_ns__addResponse.iRes);
	if (soap->error)
		return soap->error;
...
static int serve_ns__sub(struct soap *soap, Service *service)
{	struct ns__sub soap_tmp_ns__sub;
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = service->sub(soap_tmp_ns__sub.iNum1, soap_tmp_ns__sub.iNum2, soap_tmp_ns__subResponse.iRes);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = NULL;
	soap_serializeheader(soap);
...
static int serve_ns__mul(struct soap *soap, Service *service)
{	struct ns__mul soap_tmp_ns__mul;
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = service->mul(soap_tmp_ns__mul.iNum1, soap_tmp_ns__mul.iNum2, soap_tmp_ns__mulResponse.iRes);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = NULL;
	soap_serializeheader(soap);
...
static int serve_ns__divid(struct soap *soap, Service *service)
{	struct ns__divid soap_tmp_ns__divid;
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = service->divid(soap_tmp_ns__divid.iNum1, soap_tmp_ns__divid.iNum2, soap_tmp_ns__dividResponse.iRes);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = NULL;
	soap_serializeheader(soap);
