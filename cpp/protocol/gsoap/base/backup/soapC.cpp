...
SOAP_SOURCE_STAMP("@(#) soapC.cpp ver 2.8.43 2017-02-28 07:17:34 GMT")
...
{	(void)type;
	...
	case SOAP_TYPE_ns__divid:
		return soap_in_ns__divid(soap, NULL, NULL, "ns:divid");
	case SOAP_TYPE_ns__dividResponse:
		return soap_in_ns__dividResponse(soap, NULL, NULL, "ns:dividResponse");
	...
	*type = 0;
	...
	{	const char *t = soap->type;
		...
		{	*type = SOAP_TYPE_ns__divid;
			return soap_in_ns__divid(soap, NULL, NULL, NULL);
		}
		if (!soap_match_tag(soap, t, "ns:dividResponse"))
		{	*type = SOAP_TYPE_ns__dividResponse;
			return soap_in_ns__dividResponse(soap, NULL, NULL, NULL);
		}
...
{	switch (p->type)
	...
	case SOAP_TYPE_ns__subResponse:
		if (p->size < 0)
			SOAP_DELETE(static_cast<struct ns__subResponse*>(p->ptr));
		else
			SOAP_DELETE_ARRAY(static_cast<struct ns__subResponse*>(p->ptr));
		break;
	case SOAP_TYPE_ns__sub:
		if (p->size < 0)
			SOAP_DELETE(static_cast<struct ns__sub*>(p->ptr));
		else
			SOAP_DELETE_ARRAY(static_cast<struct ns__sub*>(p->ptr));
		break;
	case SOAP_TYPE_ns__mulResponse:
		if (p->size < 0)
			SOAP_DELETE(static_cast<struct ns__mulResponse*>(p->ptr));
		else
			SOAP_DELETE_ARRAY(static_cast<struct ns__mulResponse*>(p->ptr));
		break;
	case SOAP_TYPE_ns__mul:
		if (p->size < 0)
			SOAP_DELETE(static_cast<struct ns__mul*>(p->ptr));
		else
			SOAP_DELETE_ARRAY(static_cast<struct ns__mul*>(p->ptr));
		break;
	case SOAP_TYPE_ns__dividResponse:
		if (p->size < 0)
			SOAP_DELETE(static_cast<struct ns__dividResponse*>(p->ptr));
		else
			SOAP_DELETE_ARRAY(static_cast<struct ns__dividResponse*>(p->ptr));
		break;
	case SOAP_TYPE_ns__divid:
		if (p->size < 0)
			SOAP_DELETE(static_cast<struct ns__divid*>(p->ptr));
		else
			SOAP_DELETE_ARRAY(static_cast<struct ns__divid*>(p->ptr));
		break;
#ifndef WITH_NOGLOBAL
	case SOAP_TYPE_SOAP_ENV__Header:
		if (p->size < 0)
...
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_default_int(soap, &a->iNum1);
	soap_default_int(soap, &a->iNum2);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns__divid(struct soap *soap, const char *tag, int id, const struct ns__divid *a, const char *type)
{
	...
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__divid), type))
		return soap->error;
	if (soap_out_int(soap, "iNum1", -1, &a->iNum1, ""))
		return soap->error;
	if (soap_out_int(soap, "iNum2", -1, &a->iNum2, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
...
{
	size_t soap_flag_iNum1 = 1;
	size_t soap_flag_iNum2 = 1;
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	...
	if (soap->body && !*soap->href)
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
			if (soap_flag_iNum1 && soap->error == SOAP_TAG_MISMATCH)
				if (soap_in_int(soap, "iNum1", &a->iNum1, "xsd:int"))
				{	soap_flag_iNum1--;
					continue;
				}
			if (soap_flag_iNum2 && soap->error == SOAP_TAG_MISMATCH)
				if (soap_in_int(soap, "iNum2", &a->iNum2, "xsd:int"))
				{	soap_flag_iNum2--;
					continue;
				}
			if (soap->error == SOAP_TAG_MISMATCH)
		...
		if (soap_element_end_in(soap, tag))
			return NULL;
		if ((soap_flag_iNum1 > 0 || soap_flag_iNum2 > 0))
...
SOAP_FMAC1 struct ns__divid * SOAP_FMAC2 soap_instantiate_ns__divid(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (n < 0)
	{	p = SOAP_NEW(struct ns__divid);
	}
	else
	{	p = SOAP_NEW_ARRAY(struct ns__divid, n);
		k *= n;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated struct ns__divid location=%p n=%d\n", (void*)p, n));
	soap_link(soap, p, SOAP_TYPE_ns__divid, n, soap_fdelete);
	if (size)
		*size = k;
	return p;
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns__dividResponse(struct soap *soap, const char *tag, int id, const struct ns__dividResponse *a, const char *type)
{
	...
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__dividResponse), type))
		return soap->error;
	if (soap_out_int(soap, "iRes", -1, &a->iRes, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
...
SOAP_FMAC3 struct ns__dividResponse * SOAP_FMAC4 soap_in_ns__dividResponse(struct soap *soap, const char *tag, struct ns__dividResponse *a, const char *type)
{
	...
	if (soap->body && !*soap->href)
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
			if (soap_flag_iRes && soap->error == SOAP_TAG_MISMATCH)
				if (soap_in_int(soap, "iRes", &a->iRes, "xsd:int"))
				{	soap_flag_iRes--;
					continue;
				}
			if (soap->error == SOAP_TAG_MISMATCH)
...
SOAP_FMAC1 struct ns__dividResponse * SOAP_FMAC2 soap_instantiate_ns__dividResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (n < 0)
	{	p = SOAP_NEW(struct ns__dividResponse);
	}
	else
	{	p = SOAP_NEW_ARRAY(struct ns__dividResponse, n);
		k *= n;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated struct ns__dividResponse location=%p n=%d\n", (void*)p, n));
	soap_link(soap, p, SOAP_TYPE_ns__dividResponse, n, soap_fdelete);
	if (size)
		*size = k;
	return p;
}
...
SOAP_FMAC1 struct ns__mul * SOAP_FMAC2 soap_instantiate_ns__mul(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (n < 0)
	{	p = SOAP_NEW(struct ns__mul);
	}
	else
	{	p = SOAP_NEW_ARRAY(struct ns__mul, n);
		k *= n;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated struct ns__mul location=%p n=%d\n", (void*)p, n));
	soap_link(soap, p, SOAP_TYPE_ns__mul, n, soap_fdelete);
	if (size)
		*size = k;
	return p;
}
...
SOAP_FMAC1 struct ns__mulResponse * SOAP_FMAC2 soap_instantiate_ns__mulResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (n < 0)
	{	p = SOAP_NEW(struct ns__mulResponse);
	}
	else
	{	p = SOAP_NEW_ARRAY(struct ns__mulResponse, n);
		k *= n;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated struct ns__mulResponse location=%p n=%d\n", (void*)p, n));
	soap_link(soap, p, SOAP_TYPE_ns__mulResponse, n, soap_fdelete);
	if (size)
		*size = k;
	return p;
}
...
SOAP_FMAC1 struct ns__sub * SOAP_FMAC2 soap_instantiate_ns__sub(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (n < 0)
	{	p = SOAP_NEW(struct ns__sub);
	}
	else
	{	p = SOAP_NEW_ARRAY(struct ns__sub, n);
		k *= n;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated struct ns__sub location=%p n=%d\n", (void*)p, n));
	soap_link(soap, p, SOAP_TYPE_ns__sub, n, soap_fdelete);
	if (size)
		*size = k;
	return p;
}
...
SOAP_FMAC1 struct ns__subResponse * SOAP_FMAC2 soap_instantiate_ns__subResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (n < 0)
	{	p = SOAP_NEW(struct ns__subResponse);
	}
	else
	{	p = SOAP_NEW_ARRAY(struct ns__subResponse, n);
		k *= n;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated struct ns__subResponse location=%p n=%d\n", (void*)p, n));
	soap_link(soap, p, SOAP_TYPE_ns__subResponse, n, soap_fdelete);
	if (size)
		*size = k;
	return p;
}
