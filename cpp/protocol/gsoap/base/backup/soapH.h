...
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, NULL) || (soap_serialize_ns__mul(soap, p), 0) || soap_put_ns__mul(soap, p, "ns:mul", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap->error;
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_connect(soap, URL, NULL) || (soap_serialize_ns__mul(soap, p), 0) || soap_put_ns__mul(soap, p, "ns:mul", "") || soap_end_send(soap))
		return soap->error;
	return SOAP_OK;
}
...
{
	if (soap_read_ns__mul(soap, p) || soap_closesock(soap))
		return soap->error;
	return SOAP_OK;
}
#endif
...
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, NULL) || (soap_serialize_ns__mulResponse(soap, p), 0) || soap_put_ns__mulResponse(soap, p, "ns:mulResponse", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap->error;
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_connect(soap, URL, NULL) || (soap_serialize_ns__mulResponse(soap, p), 0) || soap_put_ns__mulResponse(soap, p, "ns:mulResponse", "") || soap_end_send(soap))
		return soap->error;
	return SOAP_OK;
}
...
{
	if (soap_read_ns__mulResponse(soap, p) || soap_closesock(soap))
		return soap->error;
	return SOAP_OK;
}
#endif
