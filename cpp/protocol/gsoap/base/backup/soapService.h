...
#include "soapH.h"
    ...
    class SOAP_CMAC Service {
      public:
        ...
        virtual int add(int iNum1, int iNum2, int &iRes) SOAP_PURE_VIRTUAL;
        /// Web service operation 'sub' (returns SOAP_OK or error code)
        virtual int sub(int iNum1, int iNum2, int &iRes) SOAP_PURE_VIRTUAL;
        /// Web service operation 'mul' (returns SOAP_OK or error code)
        virtual int mul(int iNum1, int iNum2, int &iRes) SOAP_PURE_VIRTUAL;
        /// Web service operation 'divid' (returns SOAP_OK or error code)
        virtual int divid(int iNum1, int iNum2, int &iRes) SOAP_PURE_VIRTUAL;
    };
#endif
