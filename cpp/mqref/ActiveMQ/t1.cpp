 ...
 * date:
 * description:
 * 编译命令 g++ -I/usr/include/apr-1 -I/usr/local/include/activemq-cpp-3.9.4 t1.cpp -lactivemq-cpp
 *
*******************************************************************************/
...
public:
    ...
    virtual void run() {
        ...
        try {
            ...
            if (useTopic) {
                destination = session->createTopic("TEST.BAR");
            } else {
                destination = session->createQueue("TEST.BAR");
            }
